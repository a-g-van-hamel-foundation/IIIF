...
class IIIFMwImgAPI extends ApiBase {
	...
	public function execute() {
		...
		$file = ( array_key_exists( 'file', $params ) ) ? $params['file'] : "";
		$pageid = ( array_key_exists( 'pageid', $params ) ) ? $params['pageid'] : ""; 
		// possibly, more complex than just pageid
		$revid = ( array_key_exists( 'revid', $params ) ) ? $params['revid'] : null;
		$repoName = ( array_key_exists( 'source', $params ) ) ? $params['source'] : null;
