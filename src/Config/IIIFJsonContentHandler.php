...
class IIIFJsonContentHandler extends JsonContentHandler {
	...
	protected function fillParserOutput(
		...
		// @todo use SMWConfig consistently
		if ( $jsonContentType == "SMWConfig" || $jsonContentType == "SemanticAnnotationsConfig" ) {
			...
			if ( gettype( $json["type"] ) == "string" ) {
				switch( $json["type"] ) {
					...
					case "ParallelisationSchema":
						...
						// e.g. https://codecs.vanhamel.nl/Json:ParallelisationSchema/LU
